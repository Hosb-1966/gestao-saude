...
function AppContent() {
  ...
  // CORRIGIDO: Função de exportação Dashboard PDF com imagens dos gráficos usando html2canvas
  const handleExportDashboardPDF = async () => {
    try {
      ...
      success('Dashboard PDF com gráficos exportado com sucesso!');
  ...
  // NOVO: Dashboard com fundo oftalmológico sutil
  const Dashboard = () => (
    <div 
      className="space-y-8 relative"
      style={{
        backgroundImage: 'url(/ophthalmology-bg.jpg)',
    ...
    >
      {/* Overlay sutil para não interferir na leitura */}
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="border-slate-200 shadow-sm bg-white bg-opacity-95">
            <CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Card className="border-slate-200 shadow-sm lg:col-span-1 bg-white bg-opacity-95">
            <CardHeader>
              <CardTitle className="text-lg font-medium text-slate-700 flex items-center gap-2">
          ...
          <Card className="border-slate-200 shadow-sm lg:col-span-2 bg-white bg-opacity-95">
            <CardHeader>
              <CardTitle className="text-lg font-medium text-slate-700 flex items-center gap-2">
